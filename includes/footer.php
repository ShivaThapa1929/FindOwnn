...
?>
        ...
        <div class="container">
            <div class="row g-4 g-lg-5 mb-5">
                ...
                <div class="col-12 col-lg-4">
                    <a class="navbar-brand footer-brand mb-4" href="./">
                        <div class="navbar-brand-logo" style="background:none;box-shadow:none;">
                            <img src="<?= $asset_base ?>assets/images/logo.png" alt="Findownn" style="width:32px;height:32px;max-width:32px;object-fit:contain;border-radius:8px;">
                        </div>
                        <span class="navbar-brand-text">FIND<span class="brand-accent">OWNN</span></span>
                    </a>
                    <p style="font-size: 0.92rem; line-height: 1.75; color: var(--text-secondary); max-width: 320px; margin-bottom: 24px;">
                        Bhuj's first sports playground booking platform. Find a slot, book your time, and just show up. It really is that simple.
                    </p>
                    <div class="d-flex gap-2 flex-wrap">
                        <a href="#" class="social-icon" aria-label="Follow us on Instagram"><i class="bi bi-instagram"></i></a>
                        <a href="#" class="social-icon" aria-label="Follow us on Facebook"><i class="bi bi-facebook"></i></a>
                        <a href="#" class="social-icon" aria-label="Follow us on Twitter / X"><i class="bi bi-twitter-x"></i></a>
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    ...
                    <div class="d-flex flex-column gap-3" style="font-size: 0.88rem; color: var(--text-secondary);">
                        <div class="d-flex align-items-start gap-2">
                            ...
                            <span>Sanskar Nagar, Bhuj<br>Gujarat — 370001</span>
                        </div>
                        <div class="d-flex align-items-center gap-2">
                            <i class="bi bi-envelope-fill text-success flex-shrink-0" style="font-size: 0.82rem;"></i>
                            <a href="mailto:<?= e($site_contact_email) ?>" class="footer-link" style="padding: 0;"><?= e($site_contact_email) ?></a>
                        </div>
                        <div class="d-flex align-items-center gap-2">
                            <i class="bi bi-telephone-fill text-success flex-shrink-0" style="font-size: 0.82rem;"></i>
                            <a href="tel:<?= e($site_phone_tel) ?>" class="footer-link" style="padding: 0;"><?= e($site_whatsapp_display) ?></a>
                        </div>
                        <div class="d-flex align-items-center gap-2">
                            <i class="bi bi-whatsapp text-success flex-shrink-0" style="font-size: 0.9rem;"></i>
                            <a href="<?= e($site_whatsapp_url) ?>" class="footer-link" style="padding: 0;" target="_blank" rel="noopener">Chat on WhatsApp</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-4 col-lg-3">
                    ...
                    <form onsubmit="event.preventDefault(); this.querySelector('button').textContent = '✓ Subscribed!'; this.querySelector('input').disabled = true;" class="d-flex flex-column gap-2">
                        <input type="email" class="glass-input" placeholder="your@email.com" required style="font-size: 0.88rem;">
                        <button type="submit" class="btn btn-premium w-100" style="font-size: 0.88rem; padding: 12px;">Subscribe</button>
                    </form>
                </div>
    ...
    <a href="<?= e($site_whatsapp_url) ?>"
       ...
       aria-label="Chat on WhatsApp — <?= e($site_whatsapp_display) ?>"
