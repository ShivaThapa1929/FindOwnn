            ...
            <div class="row g-3">
                ...
                <div class="col-12">
                    ...
                    <textarea name="description" class="form-control" rows="3"
                              ...
                              style="background:rgba(255,255,255,0.05); border-color:rgba(255,255,255,0.1); color:#fff; resize:none;"></textarea>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-3">
                    ...
                    <input type="color" name="color" class="form-control form-control-color w-100" value="#22c55e"
